import { Button, Dimensions, Pressable, ScrollView, StyleSheet, Text, TextInput, TouchableOpacity, View } from 'react-native'
    ...
    const sign =async()=>{
        if (password === password2) {
            try {
                ...
                // Hna radiri chno briti iw93 mni user ikon dar register
            ...
            Alert.alert('Password != Password2');
        }
    }
    ...
    <View style={styles.container}>
        ...
        <View style={styles.login}>
            ...
            <View style={styles.inputContainer}>
                ...
                <View style={styles.inputBox}>
                <FontAwesome style={[styles.icon,{paddingLeft:17}]} name="lock" size={23} color="gray" />
                <TextInput onChangeText={(e)=> setPassword2(e)} secureTextEntry={true} style={[styles.input,{paddingLeft:12}]} placeholder='Confirm your password here...'/>
                </View>
                ...
                />
                <Text style={styles.checkboxText}>You confirm your acceptance of the terms and conditions</Text>
                </View>
                </View>
                ...
                <View style={styles.socialMedia}>
                    <Text style={styles.alradyText}>Already i have an account</Text>
                    <TouchableOpacity style={{marginLeft:5}} onPress={() => navigation.navigate('Login')}><Text style={[styles.click]}>Click here</Text></TouchableOpacity>
                </View>
            </View>
        </View>
        </View>
